# filepath: c:\Users\wathn\dev\ContentSyndicate\app\mcp_servers\ai_writer_new.py
"""
AI Writer MCP Server
Creates human-like newsletter content using Gemini API with enhanced topic matching
"""
import json
...
class AIWriterServer:
    ...
    def _register_tools(self):
        ...
        async def generate_newsletter_content(
            ...
            """Generate newsletter content from source articles with enhanced topic matching"""
        ...
        try:
            ...
            return {
                ...
                "metadata": {
                    ...
                    "tone": tone,
                    "length": length,
                    "used_topic_matching": topic_matching_data is not None
                }
            }
